...
function MedicalInfoContent() {
  ...
  const fetchTotalCount = async(sido?: string, sgg?: string) => {
    let url = '/proxy/api/medicalCountHospital';
    if(sido && sgg) {
  ...
  const fetchNightCount = async(sido?: string, sgg?: string) => {
    let url = `/proxy/api/medicalNight?`;
    if(sido && sgg) {
      url += `sidoName=${encodeURIComponent(sido)}&sigunguName=${encodeURIComponent(sgg)}`;
    } else if(sido) {
      url += `sidoName=${encodeURIComponent(sido)}`
  ...
  const fetchHolidayCount = async(sido?: string, sgg?: string) => {
    let url = `/proxy/api/medicalHoliday?`;
    if(sido && sgg) {
      url += `sidoName=${encodeURIComponent(sido)}&sigunguName=${encodeURIComponent(sgg)}`;
    } else if(sido) {
      url += `sidoName=${encodeURIComponent(sido)}`
  ...
  const fetchCoreCount = async(sido?: string, sgg?: string, deptCode?: string) => {
    let url = `/proxy/api/medicalEssential?`;
    if (sido && sgg) {
      url += `sidoName=${encodeURIComponent(sido)}&sigunguName=${encodeURIComponent(sgg)}`
    } else if (sido) {
      url += `sidoName=${encodeURIComponent(sido)}`
  ...
  const fetchSidoList = async() => {
    try{
      const resp = await fetch('/proxy/api/sidoName');
      if(!resp.ok) {
  ...
  const fetchSggList = async(sido: string) => {
    try{
      const resp = await fetch(`/proxy/api/sigunguName?sidoName=${encodeURIComponent(sido)}`);
      if(!resp.ok) {
  ...
  const fetchHospInfo = async (page?: number, sido?: string, sgg?: string) => {
    let url = `/proxy/api/medicalInfo?page=${page}&size=5`
    if(sido && sgg) {
      url += `&sidoName=${encodeURIComponent(sido)}&sigunguName=${encodeURIComponent(sgg)}`;
    } else if(sido) {
      url += `&sidoName=${encodeURIComponent(sido)}`;
  ...
  const fetchNightHosp = async(page?: number, sido?: string, sgg?: string) => {
    let url = `/proxy/api/medicalNight?page=${page}&size=5`;
    if(sido && sgg) {
      url += `&sidoName=${encodeURIComponent(sido)}&sigunguName=${encodeURIComponent(sgg)}`;
    } else if(sido) {
      url += `&sidoName=${encodeURIComponent(sido)}`
  ...
  const fetchHolidayHosp = async(page?: number, sido?: string, sgg?: string) => {
    let url = `/proxy/api/medicalHoliday?page=${page}&size=5`;
    if(sido && sgg) {
      url += `&sidoName=${encodeURIComponent(sido)}&sigunguName=${encodeURIComponent(sgg)}`;
    } else if(sido) {
      url += `&sidoName=${encodeURIComponent(sido)}`
  ...
  const fetchCoreHosp = async(page?: number, sido?: string, sgg?: string, deptCode?: string) => {
    let url = `/proxy/api/medicalEssential?page=${page}&size=5`;
    if (sido && sgg) {
      url += `&sidoName=${encodeURIComponent(sido)}&sigunguName=${encodeURIComponent(sgg)}`
      if(deptCode) {
  ...
  const fetchHospDept = async(sido?: string, sgg?: string) => {
    let url = '/proxy/api/medicalDept?topN=5';
    if(sido && sgg) {
      url += `&sidoName=${encodeURIComponent(sido)}&sigunguName=${encodeURIComponent(sgg)}`;
    } else if(sido) {
      url += `&sidoName=${encodeURIComponent(sido)}`
  ...
  const fetchHospLocation = async(level?: number) => {
    try{
      const resp = await fetch(`/proxy/api/medicalLocation?${level}`);
      if(!resp.ok) {
  ...
  const fetchHospInfo2 = async (sido?: string, sgg?: string) => {
    let url = `/proxy/api/medicalInfo?size=10000`
    if(sido && sgg) {
      url += `&sidoName=${encodeURIComponent(sido)}&sigunguName=${encodeURIComponent(sgg)}`;
    } else if(sido) {
      url += `&sidoName=${encodeURIComponent(sido)}`;
  ...
  const handleDetailView = async (hospitalId: number) => {
    ...
    try {
      const resp = await fetch(`/proxy/api/medicalId?hospitalId=${hospitalId}`);
