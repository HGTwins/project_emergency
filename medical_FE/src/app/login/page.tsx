  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        const resp = await fetch(`/proxy/api/getMember/${username}`)
      ...
      <div className='w-1/2 max-w-sm bg-white px-6 py-8 flex flex-col justify-center items-start rounded-xl text-gray-700 border border-gray-200 shadow-md'>
        ...
        <form onSubmit={handleLogin} className='w-full flex flex-col space-y-3'>
          ...
          <div className='flex justify-center gap-4 pt-1'>
            <a href="https://nonefficient-lezlie-progressively.ngrok-free.dev/login/oauth2/authorization/google"
            ...
            <a href="https://nonefficient-lezlie-progressively.ngrok-free.dev/login/oauth2/authorization/naver"
